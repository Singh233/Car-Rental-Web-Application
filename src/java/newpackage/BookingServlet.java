...
public class BookingServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String productSql = "SELECT * FROM products WHERE id = " + Integer.toString(carid);
         ...
         BookingModel bookingModel = new BookingModel(owner, orderId, name, number, email, carname, carid, area, country, zipCode, state, city, date, paymentMethod, bill, status);
