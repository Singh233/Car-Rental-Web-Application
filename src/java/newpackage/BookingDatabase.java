...
public class BookingDatabase {
    ...
    public boolean saveProduct(BookingModel bookingModel) {
        ...
        try {
            ...
            String query = "insert into bookings(owner, orderid, name, number, email, carname, carid, area, country, zipcode, state, city, date, paymentmethod, bill, status) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            pt.setString(16, bookingModel.getStatus());
