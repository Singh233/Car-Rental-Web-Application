...
ResultSet productResultSet    = productStatement.executeQuery(productSql);    
            ...
            %>
            <div style="background-color: gray" class="status-card">
     
     <p>Waiting for Approval of Admin</p>
</div>
  ...
  <%
            ...
            %>
            <div style="background-color: #185ee0"  class="status-card">
     ...
     <p>Approved</p>
            ...
            %>
            <div style="background-color: red" class="status-card">
     ...
     <p>Rejected</p>
            ...
            %>
            <div style="height: 600px; margin-bottom: 50px;  background: rgba(255, 255, 255, 0.675);" class="overlay">
                <!-- Overlay inner wrapper -->
                <div class="overlay__inner">
                    <!-- Title -->
                    <h1 class="overlay__title">
