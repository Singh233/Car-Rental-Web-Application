            ...
            <div style="  font-family: 'Poppins', sans-serif;" class="app-header">
                <div class="app-header-left">
                    ...
                    <div class="app-sidebar">
                        ...
                        <div class="tabs">
                            <input type="radio" id="radio-1" name="tabs" onClick="window.location.href = 'welcome.jsp'" />
            ...
            <div class="overlay">
                ...
                <div class="overlay__inner">
                    <h1 class="overlay__title">
                        Hey, <%= user.getName()%>. We would love to hear from you.

                    </h1>
                    <!-- Description -->
                    <p class="overlay__description">
                        If you have any Question feel free to drop a message.
                        <strong>Please fill out the following information.</strong>
                    </p>

                    <form id='Form' action='MessageServlet' method='post'>
                        ...
                        <div class="input-icons">
                            ...
                            <input style="font-family: 'Poppins', sans-serif; font-weight: 700;" type="text" placeholder="Enter your Full Name" name="name" id="" required=""/>

                            <input style="font-family: 'Poppins', sans-serif; font-weight: 700;" type="email" placeholder="Enter your Email Address" name="email" id="" required=""/>

                            <input style="font-family: 'Poppins', sans-serif; font-weight: 700;" type="text" placeholder="Enter Subject" name="subject" required=""/>

                            <textarea rows='5' cols='42' style="font-family: 'Poppins', sans-serif; font-weight: 700;" type="text" placeholder="Enter Message" name="message" required=""></textarea>
                        </div>


                        <button type="submit" onClick='functionAlert()'  class="overlay__btn overlay__btns">
                            <span>Submit </span>
                            <span class="overlay__btn-emoji"><i class="fas fa-check"></i></span>
                        </button>
                    ...
                    <img class='customerImg' src="./img/customervector.png"/>
