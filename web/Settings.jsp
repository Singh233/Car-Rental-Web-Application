...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/settingsCard.css">
    ...
    <body>
       ...
       String userSql = "SELECT * FROM user WHERE id = " + user.getId();
...
Connection bookingConnection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","root");
        ...
        <div class="app-container">
                ...
                <div class="app-header-right">
                    ...
                    <div class="dropdown">
                        <ul class="dropdown-content">
                            <li onclick="window.location.href = 'profile.jsp'"  class="dropdown-item"><i class="fas fa-user-circle"></i> Profile</li>
                            <li class="divider"></li>
                                <li onclick="window.location.href = 'cart.jsp'"  class="dropdown-item"><i class="fas fa-shopping-cart"></i> Cart</li>
                            <li onClick="functionBookings()" class="dropdown-item"><i class="fas fa-sort"></i> Bookings</li>
                            <li style="background-color: #185ee0; color: white" class="dropdown-item"><i class="fas fa-cog"></i> Settings</li>
                            <li class="divider"></li>
            ...
            <div style="font-family: 'Poppins', sans-serif; color: #36353c; position: absolute; margin-left: 100px; margin-top: 160px; font-size: 1.6rem; font-weight: 800; z-index: 999">
                Settings&nbsp;<i style="font-weight: 800" class="fas fa-chevron-right"></i>
            </div>
            ...
            <div class="overlay">
                ...
                <div class="overlay__inner">
                    ...
                    <form action='UpdateServlet' method='post' enctype="multipart/form-data">
                        ...
                        <div class="input-icons">
                            <%
                                                    ...
                                                    if(passError != null) {
                        //                                out.println("<font color = red size = 3px style='Position: absolute; margin-top: 65px; margin-left: 320px;'>" + passError + "</font>");
                            %>
                            <i class="fas fa-lock"></i>
                            <input style="font-family: 'Poppins', sans-serif; font-weight: 700; border-color: red ;   border-width: 2px;" type="password" placeholder="Incorrect Old Password" name="oldPassword" id="" required=""/>
                            <%
                                } else {
                            %>
                            <i class="fas fa-lock"></i>
                            <input style="font-family: 'Poppins', sans-serif; font-weight: 700;" type="password" placeholder="Old Password" name="oldPassword" id="" required=""/>
                            ...
                            <i class="fas fa-lock"></i>
                            <input style="font-family: 'Poppins', sans-serif; font-weight: 700;" type="password" placeholder="Password" id="password" name="password1" id="userpass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required=""/>
                            <i class="fas fa-lock"></i>                        
                            <input style="font-family: 'Poppins', sans-serif; font-weight: 700;" type="password" placeholder="Confirm Password" id="confirm_password" name="password2" id="userpass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required=""/>
                        </div>
                        <!-- Buttons -->
                         <%
                                           String passSuccess = (String)request.getAttribute("success");  
                                           if(passSuccess != null) {
                                           
                    %>

                        <button style="background-color: #5cb85c; pointer-events: none" class="overlay__btn overlay__btns">
                    ...
                    %>
                            <button class="overlay__btn overlay__btns">
                            <span>Confirm Changes  </span>
                            <span class="overlay__btn-emoji"><i class="fas fa-user"></i></span>
                            </button>
                             <%
                    ...
                    <button onClick="location.href='profile.jsp'" class="back_button" >
                            <span><i class="fas fa-long-arrow-alt-left"></i> Back to Profile  </span>
                    ...
                    <div class="card">
                        ...
                        <div style="margin-left: 485px; margin-top: -140px; font-size: 0.9rem; color: white; z-index: 1;">
                            <%= user.getEmail()%>
                        </div>
                        <div style="margin-left: 585px; margin-top: -40px; font-size: 0.9rem; color: white; z-index: 1;">
                            <%= user.getNumber()%>
                        </div>
                        <div style="margin-left: 680px; margin-top: -22px; font-size: 0.9rem; color: white; z-index: 1;">
