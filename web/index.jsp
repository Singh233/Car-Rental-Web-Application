        ...
        <div class="container">
            ...
            <section class="background">
                <div class="content-wrapper">
                    ...
                    <button onClick="location.href='loginnew.jsp'" style="text-transform: none; font-family: Poppins; z-index: 5; " class="custom-btn btn-8"><span>Skip <i class="fas fa-chevron-right"></i></span></button>
            ...
            <section style="margin-top: -3rem;"  class="background body">
                ...
                <img style="height: 70px; width: 175px; margin-top: 5rem; margin-left: 4rem" src="img/logo2.png" alt="alt"/>
                ...
                <section style="z-index: 1; margin-top: 7rem; height: 200px" class="overlayBg"> 
                    <center style="margin:20px">
                        ...
                        <div style="z-index: 1" class="proudly">
                            <div>Ankit Vishwakarma & Sanambir Singh</div>

                            <section style="margin-top: -17px" id="lab_social_icon_footer">
                                <link href="//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">


                                <i id="social-fb" class="fa fa-facebook-square fa-3x social"></i>	 
                                <i id="social-tw" class="fa fa-twitter-square fa-3x social"></i>
                                <i id="social-fb" class="fa fa-github fa-3x social"></i>
